 ...
 *
 */
public class GenerateFailedReports extends TestListenerAdapter implements IReporter {
  public static final String TESTNG_FAILED_XML = "testng-failed.xml";

  private XmlSuite m_xmlSuite;

  public GenerateFailedReports() {
  }

  public GenerateFailedReports(XmlSuite xmlSuite) {
    m_xmlSuite = xmlSuite;
  }
...
private static void ppp(String s) {
	  System.out.println("[GenerateFailedReports] " + s);
  }
}
